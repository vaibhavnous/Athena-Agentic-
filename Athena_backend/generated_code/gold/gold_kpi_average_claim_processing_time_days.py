...
Target table: gold.fact_average_claim_processing_time_days
...
KPI_NAME = 'Average Claim Processing Time (Days)'
SOURCE_TABLE = 'silver.silver_claim_payment_expenses'
TARGET_TABLE = 'gold.fact_average_claim_processing_time_days'
VALUE_COLUMN = 'average_claim_processing_time_days_value'
...
agg_expr = avg(col('PaymentID')).alias('average_claim_processing_time_days_value')
