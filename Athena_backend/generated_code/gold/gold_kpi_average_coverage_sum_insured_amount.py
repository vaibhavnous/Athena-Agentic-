...
Target table: gold.fact_average_coverage_sum_insured_amount
...
KPI_NAME = 'Average Coverage Sum Insured Amount'
SOURCE_TABLE = 'silver.silver_claim_payment_expenses'
TARGET_TABLE = 'gold.fact_average_coverage_sum_insured_amount'
VALUE_COLUMN = 'average_coverage_sum_insured_amount_value'
...
agg_expr = avg(col('PaymentID')).alias('average_coverage_sum_insured_amount_value')
