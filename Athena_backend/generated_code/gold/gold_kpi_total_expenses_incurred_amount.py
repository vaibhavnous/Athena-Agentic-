...
KPI: Total Expenses Incurred Amount
Source table: silver.silver_claim_payment_expenses
Target table: gold.fact_total_expenses_incurred_amount
...
VALUE_COLUMN = 'total_expenses_incurred_amount_value'
...
agg_expr = sum(col('PaymentID')).alias('total_expenses_incurred_amount_value')
